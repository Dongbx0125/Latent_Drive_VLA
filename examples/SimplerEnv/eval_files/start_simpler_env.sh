...
export SimplerEnv_PATH=/code/SimplerEnv
...
if [ -n "$1" ]; then
  ...
  MODEL_PATH=/code/starVLA/playground/Checkpoints/Qwen3VL-GR00T-Bridge-RT-1/checkpoints/steps_20000_pytorch_model.pt
