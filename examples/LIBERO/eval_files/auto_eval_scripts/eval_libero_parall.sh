...
export LIBERO_HOME=/code/LIBERO  # Root directory of the LIBERO project
export LIBERO_python=/opt/conda/envs/libero/bin/python  # Path to the Python environment
